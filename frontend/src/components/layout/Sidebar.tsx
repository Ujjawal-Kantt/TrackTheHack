  ...
  return (
    <>
      <motion.aside
        ...
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-dark-100 shadow-xl border-r border-gray-800 glassmorphism
      transition-transform duration-300 ease-in-out
      ${open ? "translate-x-0" : "-translate-x-full"} 
      lg:translate-x-0 lg:relative lg:transform-none`}
      >
        <div className="flex flex-col sticky top-0 h-screen justify-between">
